...
bundle = Path(request["output_bundle_dir"]) / "simulated_official_bundle"
    ...
    json.dumps(
        {
            ...
            "adapter_provenance": {
                ...
                "editor_version": "simulated-for-unit-test",
                "workflow": "operator_assisted_cubism_editor",
                "operator_confirmed_export": True,
                "source_project_path": "fixtures/simulated.cmo3",
            },
            "logs": ["simulated official provenance for unit tests only"],
            "errors": [],
        }
    ),
    encoding="utf-8",
